    ...
    <body>
        <div class="container">
            <div class="col-xs-12 col-sm-6 col-sm-offset-3">
                ...
                <div class="well">
                    <h2>Usage example</h2>
                    <p>To retrieve a list of holidays, simply make a GET request to <a href="/v1/holidays?country=ES&amp;year=2016">/v1/holidays</a></p>
                </div>
                ...
                <div class="well">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-9"><a href="http://en.wikipedia.org/wiki/ISO_3166-1_alpha-2">ISO 3166-1 alpha-2</a> format (BE, BG, BR, CA, CZ, DE, ES, FR, GB, NO, PL, SK, SL or US)</div>
                    </div>
                    <div class="row">
