            ...
            <div class="col-xs-12 col-sm-6 col-sm-offset-3">
                ...
                <div class="well">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-9"><a href="http://en.wikipedia.org/wiki/ISO_3166-1_alpha-2" target="_blank">ISO 3166-1 alpha-2</a> format (BE, BG, BR, CA, CZ, DE, ES, FR, GB, GT, HR, IT, NL, NO, PL, SI, SK or US)</div>
                    </div>
                    <div class="row">
  ...
  "status": 200,
    "holidays": [{
      ...
      "date": "2013-05-04"
                ...
                <div class="well">
                    <h3>Contributors</h3>
                    <p>Holiday API was conceived and coded by <a href="http://joshtronic.com">Josh Sherman</a> and is provided as a free service. Special thanks to <a href="https://github.com/joshtronic/holidayapi.com/graphs/contributors">a whole bunch of awesome people</a> for contributing additional country files, fixing bugs and helping to improve the platform. Website and logo artfully designed by <a href="https://twitter.com/thegeoffoliver" target="_blank">Geoff Oliver</a> of <a href="http://www.plan8studios.com/">Plan8 Studios</a>. Holiday API is <a href="https://www.linode.com/?r=5f682793582e82ce686747c851b998dc1f86a55b" target="_blank">proudly hosted by Linode</a>.</p>
                </div>
                <footer class="lead">
